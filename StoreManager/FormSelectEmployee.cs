...
namespace StoreManager
{
    public partial class FormSelectEmployee : Form
    {
        ...
        {
            comboBox_Position.DataSource = _querySQLServer.Procedure_without_parameters("Select_All_Position");
            comboBox_Position.ValueMember = "position";
            //toolStripComboBoxSearchEmployee.ComboBox.DataSource =  
        }

        private void _Refresh_dataGridViews()
        {
            dataGridView_Employees.DataSource = _querySQLServer.Procedure_without_parameters("Select_All_Employees");
